...
// 	require.Equal(t, 202553439706, sum)
// }
...
// 			require.Equal(t, tc.want, parseValue(tc.in))
// 		})
// 	}
// }
...
// 			return val
// 		}
// 		ch, width = utf8.DecodeRuneInString(in[pos:])
// 		pos += width
// 		switch {
// 		case ch == ' ':
// 			continue
...
// 			op = div
// 		case ch >= '0' && ch <= '9':
// 			val = op(val, int(ch-'0')) // reduce
// 		case ch == '(':
// 			// Find closing parenthesis
// 			end := closeParenIndex(in[pos:])
// 			if end < 0 {
// 				panic(fmt.Sprintf("missing end parenthesis for start at %v", pos))
// 			}
// 			val = op(val, parseValue(in[pos:pos+end]))
// 			pos += end
// 		case ch == ')':
// 		default:
// 			panic(fmt.Sprintf("invalid character %v, %v", ch, string(ch)))
// 		}
// 	}
...
// 	} {
// 		t.Run(fmt.Sprintf("%v", tc.in), func(t *testing.T) {
// 			require.Equal(t, tc.want, closeParenIndex(tc.in))
// 		})
// 	}
// }

// func closeParenIndex(s string) (pos int) {
// 	var pop, width int
// 	var ch rune
// 	for pos < len(s) {
